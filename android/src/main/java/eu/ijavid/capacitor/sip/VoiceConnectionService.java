...
import static eu.ijavid.capacitor.sip.Constants.ACTION_CHECK_REACHABILITY;
import static eu.ijavid.capacitor.sip.Constants.ACTION_ONGOING_CALL;
import static eu.ijavid.capacitor.sip.Constants.ACTION_ON_CREATE_CONNECTION_FAILED;
...
import static eu.ijavid.capacitor.sip.Constants.EXTRA_CALL_NUMBER_SCHEMA;
import static eu.ijavid.capacitor.sip.Constants.EXTRA_CALL_UUID;
import static eu.ijavid.capacitor.sip.Constants.EXTRA_DISABLE_ADD_CALL;
import static eu.ijavid.capacitor.sip.Constants.FOREGROUND_SERVICE_TYPE_MICROPHONE;
